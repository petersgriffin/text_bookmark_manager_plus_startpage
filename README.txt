...
Startpage Creation Usage (render_startpage script activates virtual env):

render_startpage.py [-h] [-d] [-v] [--dry-run] source-directory output-directory
...
Google New Tab shortcut override
...
5. past in the shell command:

open -a "Google Chrome" file:///<PATH>/startpage/startpage.html
